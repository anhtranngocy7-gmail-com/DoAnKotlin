...
class Nhom3AnInnerAdapter : RecyclerView.Adapter<Nhom3AnInnerAdapter.ViewHolder>()  {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): Nhom3AnInnerAdapter.ViewHolder {
        var layoutInflater = LayoutInflater.from(parent.context)
        var view = layoutInflater.inflate(R.layout.nhom3_an_itemview_reportexpense,parent,false)
        return Nhom3AnInnerAdapter.ViewHolder(view)
    }

    override fun onBindViewHolder(holder: Nhom3AnInnerAdapter.ViewHolder, position: Int) {
